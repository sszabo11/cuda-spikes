...
if spikes is not None:
    ...
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c1_raster.png", dpi=150)
    plt.close()
    print("✓ 1_raster.png")
...
if population is not None:
    ...
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c2_population_summary.png", dpi=150)
    plt.close()
...
if membranes is not None:
    ...
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c3_membrane_traces.png", dpi=150)
    plt.close()
...
if traces is not None:
    ...
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c4_stdp_traces.png", dpi=150)
    plt.close()
...
if weights is not None:
    ...
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c5_weight_distribution.png", dpi=150)
    plt.close()
...
if weights is not None:
    ...
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c6_weight_heatmap.png", dpi=150)
    plt.close()
...
if weights is not None:
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c7_weight_over_time.png", dpi=150)
    plt.close()
...
if refractory is not None:
    ...
    ax.set_ylabel("Neuron ID")
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c8_refractory_heatmap.png", dpi=150)
    plt.close()
...
if spikes is not None:
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c9_spikes_per_neuron.png", dpi=150)
    plt.close()
...
if thresholds is not None:
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig(f"{PLOTS_DIR}/c10_threshold_drift.png", dpi=150)
    plt.close()
